 ...
 * Description: A clique is a subset of vertices of an undirected graph such that every two distinct
 * vertices in the clique are adjacent.Runs a callback for all maximal cliques in a graph (given as a
