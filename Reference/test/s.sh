...
do
    ./generator > input1
    ./original < input1 > original_output || { echo "${orange}test_case #$i $1: ${bold}${red}RE${reset} "; exit 1; }

    ./brute < input1 > brute_outpu || { echo "${orange}test_case #$i $2: ${bold}${red}RE${reset} "; exit 1; }
