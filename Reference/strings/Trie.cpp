 ...
 * License: CO0
 * Description: Builds a trie for a set of strings, a trie is a tree in which we store letter by letter strings reusing previous 
 * nodes, this tree gives the capacity of build a dictionary and check if some word exists in the dictionary.
