/**
 * Author: Alberto Silva / gepardo's CodeForces blog https://codeforces.com/blog/entry/61203 for the hilbert order
 * Date: 2019-10-30
...
signed main(){__
    ...
    while(T--){
        ...
        for(int id = 0;id<m;id++){
            ...
            Q.push_back({l,r,id});
            // if you use hilbert order must call calcOrder() for each query
            Q.back().calcOrder();
        }
        sort(Q.begin(),Q.end());
