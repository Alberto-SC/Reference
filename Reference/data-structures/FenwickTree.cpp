 ...
 * Date: 2019-10-30
 * Description: Fenwick tree is an structures that allows compute an assosiative but not invertible functon (Group)
 * in a range [l,r] efficienly
 * Time: O(\log{N}) per query  or O(\log{N} ^2 ) for bit2D.
 * Usage:
 *   bit.resize(n);
